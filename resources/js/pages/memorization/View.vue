...
.ayah-item {
  ...
  /* Prevent overflow if word is too long */
  display: flex;
  padding: 5px;
}
...
.ayah-number {
  font-weight: bold;
  width: auto;
  /* Auto width for the first column */
  font-size: 12px;
}
...
.ayah-text {
  font-size: 20px;
  flex-grow: 1;
  /* This makes the column grow to take up remaining space */
  margin-left: 20px;
  text-align: right;
  /* Adjust text alignment as needed for Arabic */
  direction: rtl;
